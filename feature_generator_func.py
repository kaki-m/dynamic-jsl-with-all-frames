...
def feature_caluc(start_index, end_index, distance_average, angle_average, thumb_direction_averages, index_finger_direction_averages, middle_finger_direction_averages, ring_finger_direction_averages, pinkie_finger_direction_averages):
        ...
        for k in range(20):
            for l in range(k+1, 21):
                ...
                if(l-k==1) and k%4!=0 or (k==0 and(l==1 or l==5 or l==9 or l==13 or l==17)):
                    continue
                if (j==start_index) and (k == 0) and (l == 0):
